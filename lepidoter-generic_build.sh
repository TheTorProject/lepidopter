...
rm -f /debconf.set
apt-get update
apt-get -y install git-core binutils ca-certificates curl locales console-common ntp openssh-server less parted vim keyboard-configuration
...
apt-get -y install tor lsb-release sudo screen tcpdump libffi-dev
